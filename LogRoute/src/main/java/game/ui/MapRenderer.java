...
public class MapRenderer {
        ...
        for (int x = startX; x < endX; x++) {
            for (int y = startY; y < endY; y++) {
                ...
                if (tile instanceof CityTile) {
                    gc.setFill(Color.rgb(200, 140, 30, 0.3));
                    gc.fillRect(px + 2, py + 2, TILE_SIZE - 4, TILE_SIZE - 4);
                }
                if (tile instanceof IndustryTile) {
                    gc.setFill(Color.rgb(100, 40, 120, 0.3));
                    gc.fillRect(px + 2, py + 2, TILE_SIZE - 4, TILE_SIZE - 4);
                }
                if (map.isCityInternalRoad(x, y)) {
                    gc.setFill(Color.rgb(180, 140, 60, 0.4));
                    gc.fillRect(px, py, TILE_SIZE, TILE_SIZE);
                }
    ...
    private void renderTruckSprite(GraphicsContext gc, Color color, boolean hasCargo) {
        ...
        gc.fillRoundRect(-11, -6, 14, 12, 3, 3);
        if (hasCargo) {
            gc.setFill(Color.rgb(255, 255, 255, 0.85));
            gc.fillRoundRect(-9, -4, 10, 8, 2, 2);
        }
        gc.setFill(color);
        gc.fillRoundRect(3, -7, 10, 14, 4, 4);
        gc.setFill(Color.rgb(180, 220, 255, 0.9));
        gc.fillRoundRect(9, -5, 3, 10, 2, 2);
        ...
        gc.setLineWidth(0.8);
        gc.strokeRoundRect(-11, -7, 24, 14, 4, 4);
    }
    ...
    private void renderBusSprite(GraphicsContext gc, Color color, boolean hasPassengers) {
        gc.setFill(color);
        gc.fillRoundRect(-12, -7, 24, 14, 5, 5);
        gc.setFill(color.brighter());
        gc.fillRect(-10, -2, 20, 4);
        gc.setFill(Color.rgb(180, 220, 255, 0.9));
        for (int i = 0; i < 4; i++) {
            gc.fillRoundRect(-9 + i * 5, -6, 3, 4, 1, 1);
            gc.fillRoundRect(-9 + i * 5, 2, 3, 4, 1, 1);
        }
        gc.setFill(Color.rgb(160, 210, 255));
        gc.fillRoundRect(10, -5, 3, 10, 2, 2);
        if (hasPassengers) {
            gc.setFill(Color.rgb(255, 255, 100, 0.7));
            for (int i = 0; i < 4; i++) {
                gc.fillRoundRect(-9 + i * 5, -5, 3, 3, 1, 1);
            }
        }
        gc.setFill(Color.web("#222"));
        gc.fillOval(-9, -9, 4, 4);
        ...
        gc.setStroke(color.darker().darker());
        gc.setLineWidth(0.8);
        gc.strokeRoundRect(-12, -7, 24, 14, 5, 5);
    }
     ...
     */
    public void renderMinimap(Canvas miniCanvas) {
